...
# a. using 1 CPU
plt.subplot(2,2,1)
ijk_1CPU = np.array([ijk_128[0],ijk_256[0],ijk_512[0],ijk_1024[0],ijk_2048[0]])
jik_1CPU = np.array([jik_128[0],jik_256[0],jik_512[0],jik_1024[0],jik_2048[0]])
jki_1CPU = np.array([jki_128[0],jki_256[0],jki_512[0],jki_1024[0],jki_2048[0]])
kji_1CPU = np.array([kji_128[0],kji_256[0],kji_512[0],kji_1024[0],kji_2048[0]])
kij_1CPU = np.array([kij_128[0],kij_256[0],kij_512[0],kij_1024[0],kij_2048[0]])
ikj_1CPU = np.array([ikj_128[0],ikj_256[0],ikj_512[0],ikj_1024[0],ikj_2048[0]])
matrix_size = np.array([m.log(128,2),m.log(256,2),m.log(512,2),m.log(1024,2),m.log(2048,2)])
...
plt.plot(matrix_size,kji_1CPU,'-*',label='kji method',linewidth=3,markersize=12)
plt.plot(matrix_size,kij_1CPU,'-D',label='kij method',linewidth=4,markersize=12)
plt.plot(matrix_size,ikj_1CPU,'-s',label='ikj method',linewidth=2,markersize=10)
...
# b. using 2 CPU
plt.subplot(2,2,2)
ijk_2CPU = np.array([ijk_128[1],ijk_256[1],ijk_512[1],ijk_1024[1],ijk_2048[1]])
jik_2CPU = np.array([jik_128[1],jik_256[1],jik_512[1],jik_1024[1],jik_2048[1]])
jki_2CPU = np.array([jki_128[1],jki_256[1],jki_512[1],jki_1024[1],jki_2048[1]])
kji_2CPU = np.array([kji_128[1],kji_256[1],kji_512[1],kji_1024[1],kji_2048[1]])
kij_2CPU = np.array([kij_128[1],kij_256[1],kij_512[1],kij_1024[1],kij_2048[1]])
ikj_2CPU = np.array([ikj_128[1],ikj_256[1],ikj_512[1],ikj_1024[1],ikj_2048[1]])
matrix_size = np.array([m.log(128,2),m.log(256,2),m.log(512,2),m.log(1024,2),m.log(2048,2)])
...
plt.plot(matrix_size,kji_2CPU,'-*',label='kji method',linewidth=3,markersize=12)
plt.plot(matrix_size,kij_2CPU,'-D',label='kij method',linewidth=4,markersize=12)
plt.plot(matrix_size,ikj_2CPU,'-s',label='ikj method',linewidth=2,markersize=10)
plt.xticks(matrix_size)
plt.ylabel('Time(Sec)',fontsize=16)
...
# c. using 3 CPU
plt.subplot(2,2,3)
ijk_3CPU = np.array([ijk_128[2],ijk_256[2],ijk_512[2],ijk_1024[2],ijk_2048[2]])
jik_3CPU = np.array([jik_128[2],jik_256[2],jik_512[2],jik_1024[2],jik_2048[2]])
jki_3CPU = np.array([jki_128[2],jki_256[2],jki_512[2],jki_1024[2],jki_2048[2]])
kji_3CPU = np.array([kji_128[2],kji_256[2],kji_512[2],kji_1024[2],kji_2048[2]])
kij_3CPU = np.array([kij_128[2],kij_256[2],kij_512[2],kij_1024[2],kij_2048[2]])
ikj_3CPU = np.array([ikj_128[2],ikj_256[2],ikj_512[2],ikj_1024[2],ikj_2048[2]])
matrix_size = np.array([m.log(128,2),m.log(256,2),m.log(512,2),m.log(1024,2),m.log(2048,2)])
...
plt.plot(matrix_size,kji_3CPU,'-*',label='kji method',linewidth=3,markersize=12)
plt.plot(matrix_size,kij_3CPU,'-D',label='kij method',linewidth=4,markersize=12)
plt.plot(matrix_size,ikj_3CPU,'-s',label='ikj method',linewidth=2,markersize=10)
plt.xticks(matrix_size)
plt.ylabel('Time(Sec)',fontsize=16)
...
# d. using 4 CPU
plt.subplot(2,2,4)
ijk_4CPU = np.array([ijk_128[3],ijk_256[3],ijk_512[3],ijk_1024[3],ijk_2048[3]])
jik_4CPU = np.array([jik_128[3],jik_256[3],jik_512[3],jik_1024[3],jik_2048[3]])
jki_4CPU = np.array([jki_128[3],jki_256[3],jki_512[3],jki_1024[3],jki_2048[3]])
kji_4CPU = np.array([kji_128[3],kji_256[3],kji_512[3],kji_1024[3],kji_2048[3]])
kij_4CPU = np.array([kij_128[3],kij_256[3],kij_512[3],kij_1024[3],kij_2048[3]])
ikj_4CPU = np.array([ikj_128[2],ikj_256[3],ikj_512[3],ikj_1024[3],ikj_2048[3]])
matrix_size = np.array([m.log(128,2),m.log(256,2),m.log(512,2),m.log(1024,2),m.log(2048,2)])
...
plt.plot(matrix_size,kji_4CPU,'-*',label='kji method',linewidth=3,markersize=12)
plt.plot(matrix_size,kij_4CPU,'-D',label='kij method',linewidth=4,markersize=12)
plt.plot(matrix_size,ikj_4CPU,'-s',label='ikj method',linewidth=2,markersize=10)
plt.xticks(matrix_size)
plt.ylabel('Time(Sec)',fontsize=16)
plt.xlabel('lg(square matrix.length)',fontsize=16)
